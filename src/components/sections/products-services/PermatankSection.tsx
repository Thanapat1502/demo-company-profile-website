...
export default function PermatankSection({
  ...
  const videoUrl = videoContent?.video_url || null;

  return (
    <section id='permatank' className="py-8 sm:py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-3 order-2 lg:order-2">
