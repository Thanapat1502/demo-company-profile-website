...
export const ProductCard: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent duration-500 ease-out group-hover:opacity-0"></div>
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-2 md:p-6">
        ...
        <div className="transform transition-transform duration-500 ease-out group-hover:-translate-y-0 md:x-group-hover:-translate-y-12 group-hover:opacity-0 ">
          <div className="md:space-y-3">
            {/* Product Title - Moves up on hover */}
            <h3 className="text-md lg:text-md font-normal text-white leading-relaxed transform transition-all duration-500 ease-out">
              {productName}
            </h3>

            {/* Product Description - Moves up on hover */}
            <p className="hidden text-white/80 text-sm md:text-lg leading-relaxed line-clamp-2 transform transition-all duration-500 ease-out">
              {productDescription}
            </p>
          </div>
        </div>
