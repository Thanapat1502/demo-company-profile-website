...
export default function ImageCarouselHero({
  ...
  return (
    <section
      className={`relative h-screen min-h-screen flex items-center justify-center overflow-hidden hero-section ${className}`}>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 luxury-scroll-indicator">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-2 text-white/60 text-xs uppercase tracking-widest font-light">
            Scroll
          </div>
        </div>
      </div>
