  ...
  const contactOptions = [
    {
      ...
      href: "mailto:info@padungsilpa.group",
    ...
    },
    {
      ...
      href: "https://line.me/ti/p/@padungsilpa",
      color: "bg-green-400 hover:bg-green-500",
    },
    {
      name: "Facebook",
      icon: <Facebook className="w-5 h-5" />,
      href: "https://facebook.com/padungsilpa",
      color: "bg-blue-600 hover:bg-blue-700",
    },
    {
      name: "YouTube",
      icon: <Youtube className="w-5 h-5" />,
      href: "https://youtube.com/@padungsilpa",
    ...
    },
    {
      ...
      href: "https://tiktok.com/@padungsilpa",
      ...
      >
        {contactOptions.map((option, index) => (
          <Link
            ...
            className={`flex items-center justify-center w-12 h-12 rounded-full text-white shadow-lg transition-all duration-300 hover:scale-110 ${
              option.color
            }`}
            style={{
