  ...
  const contactOptions = [
    {
      ...
      href: `mailto:${contactInfo?.email || contact.email}`,
      color: "bg-red-500 hover:bg-red-600",
    },
    {
      name: locale === "th" ? "โทรศัพท์" : "Phone",
      icon: <Phone className="w-5 h-5" />,
      href: `tel:${contactInfo?.tel || contact.phone}`,
    ...
    },
    {
      ...
      href: contactInfo?.line || "https://line.me/ti/p/@oildevelopment",
      color: "bg-green-400 hover:bg-green-500",
    },
    {
      name: "Facebook",
      icon: <Facebook className="w-5 h-5" />,
      href: contactInfo?.facebook || "https://facebook.com/oildevelopment",
      color: "bg-blue-600 hover:bg-blue-700",
    },
    {
      name: "YouTube",
      icon: <Youtube className="w-5 h-5" />,
      href: contactInfo?.youtube || "https://youtube.com/@oildevelopment",
    ...
    },
    {
      ...
      href: contactInfo?.tiktok || "https://tiktok.com/@oildevelopment",
