        ...
        <NavbarContent>
          ...
          <NavbarBrand>
            <Link href="/" className="flex items-center space-x-4 group">
              <div
                className={`w-12 h-12 rounded-md bg-white/60 hover:bg-white/30 text-white border border-white/30 hover:border-white/50 backdrop-blur-sm flex items-center justify-center transition-all duration-700 ease-out group-hover:scale-110  relative overflow-hidden ${
                  isAtTop ? "shadow-xl shadow-white/20" : "shadow-lg"
                }`}
              ...
              <div className="flex flex-col">
                ...
                <span
                  className={`text-md font-bold  transition-all duration-700 ease-out group-hover:tracking-[0.3em] ${
                    isAtTop ? "text-white/80" : "text-gray-500"
                  }`}>
                  GROUP
                </span>
              </div>
          ...
          {navigationItems.map((item, index) => (
            <NavbarItem key={item.href}>
              <Link
                ...
                {/* Subtle glow effect */}
                <div
                  className={`absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 ease-out ${
                    isAtTop
        ...
        <NavbarContent justify="end" className="gap-4">
          ...
          <NavbarItem>
            <Button
              ...
              className={`transition-all duration-700 ease-out hover:scale-110 hover:rotate-12 relative group ${
                isAtTop
