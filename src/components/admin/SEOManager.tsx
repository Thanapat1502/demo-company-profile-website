...
export default function SEOManager() {
  ...
  const handleSave = async (formData: SEOPage) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success(
          `SEO page ${editingPage?.id ? "updated" : "created"} successfully`
        );
        fetchSEOPages();
        onClose();
        setEditingPage(null);
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Manage SEO metadata for all pages and locales
          </p>
        </div>
        <Button
          color="primary"
...
function SEOPageModal({
  ...
  const [twitterImageUpload, setTwitterImageUpload] =
  ...
  useEffect(() => {
    if (editingPage) {
      ...
      if (editingPage.og_image) {
        setOgImageUpload((prev) => ({
          ...prev,
          preview: editingPage.og_image!,
        }));
      }
      if (editingPage.twitter_image) {
        setTwitterImageUpload((prev) => ({
          ...prev,
          preview: editingPage.twitter_image!,
        }));
      }
    } else {
  ...
  const handleImageUpload = async (file: File, type: "og" | "twitter") => {
    const setUploadState =
      type === "og" ? setOgImageUpload : setTwitterImageUpload;
  ...
  const removeImage = async (type: "og" | "twitter") => {
    const currentImage =
      type === "og" ? formData.og_image : formData.twitter_image;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const cleanedData = {
      ...formData,
      page_path: formData.page_path.startsWith("/")
        ? formData.page_path
        : "/" + formData.page_path,
    };
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
              ...
              <Tab
                ...
                <div className="space-y-6 py-4">
                  ...
                  <Input
                    ...
                    placeholder="https://www.localhost3000.group/page-path"
                  />
                </div>
              </Tab>
              ...
              <Tab
                ...
                <div className="space-y-6 py-4">
                  ...
                  <Textarea
                    ...
                    placeholder={
                      formData.description || "Enter Open Graph description"
                    }
                    rows={3}
                  />
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Recommended size: 1200x630px. Max file size: 5MB. Formats:
                      JPG, PNG, WebP
                    </p>
                  </div>
                </div>
              ...
              <Tab
                ...
                <div className="space-y-6 py-4">
                  <Select
                    ...
                    <SelectItem key="summary_large_image">
                      Summary Large Image
                    </SelectItem>
                  ...
                  <Textarea
                    ...
                    placeholder={
                      formData.description || "Enter Twitter description"
                    }
                    rows={3}
                  />
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Recommended size: 1200x675px. Max file size: 5MB. Formats:
                      JPG, PNG, WebP
                    </p>
                  </div>
                </div>
                  ...
                  <Switch
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500">
                        Include in sitemap and search results
                      </span>
                    </div>
                  </Switch>
                </div>
                    ...
                    <CardBody>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-green-700 text-sm">
                          https://www.localhost3000.group
                          {formData.page_path || "/page-path"}
                        </div>
          ...
          <ModalFooter className="px-6 py-4 border-t border-gray-200">
            ...
            <Button
              ...
              isDisabled={
                ogImageUpload.uploading || twitterImageUpload.uploading
              }>
