...
export const ContentManager = () => {
  ...
  }, [selectedPage, currentPageConfig]);
  ...
  const onSubmit = async (data: ContentFormData) => {
    ...
    try {
      ...
      // Create FormData for hero section
      const formData = new FormData();
      formData.append("id", currentPageConfig.heroSection.id);
      formData.append("existing_images", JSON.stringify(existingHeroImages));
